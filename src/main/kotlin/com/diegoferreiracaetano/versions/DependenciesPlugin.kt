...
class DependenciesPlugin : Plugin<Project> {
    ...
    private val Project.configDir get() = System.getProperty("test")
    ...
    override fun apply(project: Project) {
        ...
        project.apply {
            it.from("${project.configDir}/tools/ktlint.gradle")
            it.from("${project.configDir}/tools/jacoco.gradle")
            it.from("${project.configDir}/tools/sonar.gradle")
            it.plugin("jacoco")
                ...
                project.configure(listOf<BaseExtension>()) {
                    it.signingConfigs {
                        ...
                        it.register("customDebug") {
                            it.storeFile = File("${project.configDir}/debug.keystore")
